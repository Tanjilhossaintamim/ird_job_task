import topsvg from "@/assets/dua-logo.svg";
import Image from "next/image";
import LeftNavLink from "../leftsidenavigation/LeftNavLink";
const LeftSide = () => {
  return (
    <div className="flex flex-col justify-between items-center py-5">
      <div>
        <Image
          ...
          height={65}
          width={65}
          className="shadow-xl shadow-[#ECF7F1]"
        />
      </div>
      ...
      <div>
        <div>
          <a href="/support">
            <button className="w-14 h-14 bg-green-600 shadow-xl shadow-[#ECF7F1] rounded-lg  text-white text-sm flex items-center justify-center">
